    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ClienteLivros", x => new { x.LivroId, x.ClienteId });
                    table.ForeignKey(
                        name: "FK_ClienteLivros_Clientes_ClienteId",
                        column: x => x.ClienteId,
                        principalTable: "Clientes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ClienteLivros_Livros_LivroId",
                        column: x => x.LivroId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ClienteLivros_ClienteId",
                table: "ClienteLivros",
                column: "ClienteId");
